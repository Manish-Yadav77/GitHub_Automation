// Create Automation Page - src/pages/CreateAutomation.jsx
...
const CreateAutomation = () => {
  ...
  const fetchRepositories = async () => {
    try {
      ...
      toast.error('Failed to load repositories. Please connect your GitHub account.');
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success('Selected repository saved successfully!');
      navigate('/dashboard');
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">Set up a new GitHub commit automation rule</p>
        </div>
